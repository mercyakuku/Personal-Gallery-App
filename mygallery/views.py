...
def categories(request,category_name,image_id):
    ...
    try:
        ...
        raise Http404()
    return render(request,"categories.html",{'title':title,"image":image, "locations":locations, "image_category":image_category})
